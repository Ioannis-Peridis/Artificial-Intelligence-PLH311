...
public class ClientMonteCarlo
{
	...
	private void receiveMessages()
	{
		...
		while(true)
		{
			world.scoreBlack = scoreBlack;
			world.scoreWhite = scoreWhite;
			try
			{
	...
	{
		ClientMonteCarlo client = new ClientMonteCarlo();
